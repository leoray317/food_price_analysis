...
model.fit(trainX_dim3, trainY,epochs=100, batch_size=6, verbose=2,validation_split =0.2)
...
trainScore = mape(trainY, trainPre)
print('Train Score: %.2f MAPE' % (trainScore))
testScore = mape(testY, testPre)
...
trainPredictPlot[0:len(trainPredict), :] = trainPre
...
testPredictPlot[len(trainPredict):len(data), :] = testPre
#
